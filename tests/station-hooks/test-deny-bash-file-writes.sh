...
# SPEC-CLAUDE.md §8). Run: bash tests/station-hooks/test-deny-bash-file-writes.sh
...
check pass "engine-writes-db"  'python3 skills/okf-kg/scripts/okf_kg.py ingest ~/vault'
...
check pass "recursive-copy"    'cp -R skills/okf-kg /tmp/kb-copy'
