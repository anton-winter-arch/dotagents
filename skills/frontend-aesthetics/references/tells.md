...
| `handrolled-icon` | WARN | Inline `<svg><path>` icons read as improvised. |
...
| `radius-scale` | WARN | More than two distinct corner radii. Round buttons in a square layout is two styles, not one. |
