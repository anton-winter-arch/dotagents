...
**Exception:** code blocks, quoted material, test fixtures and any file whose
job is to contain these characters. The linter skips fenced code by default.
