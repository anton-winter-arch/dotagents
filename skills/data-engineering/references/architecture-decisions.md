...
3. **Zingg is AGPL-3.0**, which is copyleft and will matter to legal review in a way that
...
4. **dbt and SQLMesh arrived at Apache-2.0 from opposite directions.** dbt loosened its
