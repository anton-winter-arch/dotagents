...
description: >-
  ...
  a scored inline retrieval cert with explanatory feedback, recorded as a
  study-guide artifact in LEARNING/. Use when the user wants to be taught,
  learn, absorb, master, or get durably up to speed on a topic - "teach me X",
  "help me learn/understand X", "quiz me / test me / certify me on X", "make me
  a study guide", "I just read this, make it stick" - especially right after a
  deep-research brief or any substantial document, and when re-testing a
  previously learned topic ("re-cert me on X", "am I still solid on X"). Also
  on /teach-me. Not for orienting in a codebase, not for fact-finding
  (deep-research), not for a one-line question.
---
