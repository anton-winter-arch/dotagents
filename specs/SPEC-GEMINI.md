...
**Not verified here.** Gemini CLI is not installed on this machine (`~/.gemini`
absent); the above is from Google's documentation as of 2026-07-31.
...
A Gemini CLI documentation page has carried a notice that for unpaid-tier and
Google One users it will be **replaced by Antigravity CLI**. That was seen during
research on 2026-07-31 and not confirmed against a primary announcement. Verify
before investing in this station.
